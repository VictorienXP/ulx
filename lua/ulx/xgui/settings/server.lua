...
plist:Add( xlib.makecheckbox{ label="Confirm mapchange", repconvar="ulx_votemap2Confirmation" } )
...
plist:Add( xlib.makecheckbox{ label="Confirm votekick", repconvar="ulx_votekickConfirmation" } )
plist:Add( xlib.makelabel{ label="\nVoteban Settings" } )
...
plist:Add( xlib.makecheckbox{ label="Confirm voteban", repconvar="ulx_votebanConfirmation" } )
